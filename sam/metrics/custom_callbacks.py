...
class R2Evaluation(Callback):
    def __init__(
        ...
        NOTE: this should only be used with MLPTimeseriesRegressor models, not any custom keras model.
        NOTE-2: this function returns r2 with the keras_model.predict function. This means that
            if values are differences in MLPTimeseriesRegressor, it returns r2 for the differenced values.
