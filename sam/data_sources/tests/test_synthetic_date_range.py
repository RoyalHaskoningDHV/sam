...
class TestCreateSyntheticTimes(unittest.TestCase):
    ...
    def test_nonoise(self):
        ...
        expected = pd.DatetimeIndex(np.array(['2016-01-01 00:00:00', '2016-01-01 01:00:00',
                                              '2016-01-01 02:00:00']))
    ...
    def test_incorrect_input(self):
        self.assertRaises(Exception, synthetic_date_range, '2016-01-01 02:00:00',
                          '2016-01-01 00:30:00', '2H')
        self.assertRaises(Exception, synthetic_date_range, '2016-01-01', '2017-01-01', '1 hour')
        self.assertRaises(Exception, synthetic_date_range, '2016-01-01', '2017-01-01',
                          max_delay="1")
        self.assertRaises(Exception, synthetic_date_range, '2016-01-01', '2017-01-01',
                          random_stop_freq=[1])
        ...
        self.assertRaises(Exception, synthetic_date_range, '2016-01-01', '2017-01-01',
                          random_stop_freq=1, random_stop_max_length=-1)
    ...
    def test_random_stops(self):
        ...
        result = synthetic_date_range(start='2016-01-01 00:00:00', end='2016-02-01 00:30:00',
                                      freq='H', random_stop_freq=0.5)
    ...
    def test_longer_stops(self):
        result = synthetic_date_range(start='2016-01-01 00:00:00', end='2016-02-01 00:30:00',
                                      freq='H', random_stop_freq=0.1, random_stop_max_length=3)
        expected_length = 31*24
    ...
    def test_seed(self):
        foo = synthetic_date_range(start='2016-01-01 00:00:00', end='2016-02-01 00:30:00',
                                   freq='H', max_delay=100, random_stop_freq=0.1,
                                   random_stop_max_length=3, seed=42)
        bar = synthetic_date_range(start='2016-01-01 00:00:00', end='2016-02-01 00:30:00',
                                   freq='H', max_delay=100, random_stop_freq=0.1,
                                   random_stop_max_length=3, seed=42)
