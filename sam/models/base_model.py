    ...
    def preprocess(
        ...
        if X.isna().any().any():
            ...
            raise ValueError(
                ...
                "Please handle these NaN values before fitting the model this can be done with:\n"
                "1) feature_engineering (e.g. with imputation)\n"
                "2) setting stitch_on_x to True, which will remove all rows containing NaN.\n"
            )
