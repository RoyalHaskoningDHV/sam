...
class TestSamReshape(unittest.TestCase):
    ...
    def setUp(self):
        self.time = pd.Series(pd.date_range('2018-01-01 11:00:00', '2018-01-01 15:00:00',
                                            freq='H'))
    ...
    def test_alternate_colnames(self):
        ...
        wide2 = wide2.rename({'A_X': 'A#X', 'B_X': 'B#X', 'C_X': 'C#X',
                              'A_Y': 'A#Y', 'B_Y': 'B#Y', 'C_Y': 'C#Y',
