...
html_logo = str((root_folder / "docs" / "source" / "images" / "logo.png").resolve())
...
latex_documents = [
    (master_doc, "sam.tex", "sam Documentation", "Ynformed", "manual"),
]
...
man_pages = [(master_doc, "sam", "sam Documentation", [author], 1)]
